...
2. I will give the source text soon. You will reply with its translation to NVC. Your reply must be in the same langauge as the source text. If the source text is in Hebrew, you MUST reply in Hebrew. If the source text is in English, you MUST reply in English. Etc.
  
3. Please avoid subjective terms such as 'recklessly', and use more objective language to describe the behavior observed.

4. Also please avoid the word "observe", and use see/hear/notice instead.
